...
청계천복개도로 노후 포장 공사로 인해 교통통제 및 우회노선 운영 예정입니다. 아래의 내용을 참고하시어 통행에 유의하시기 바랍니다. □ 통제개요 ○ 공사기간 : 5/18(월)~5/27(수) (일별 22:00~익일 06:00)○ 공사구간 : 청계천 복개도로 고산자교~무학교 구간 ○ 대상노선 : 2221번(신흥운수)○ 미운행구간 : 시립동부병원 앞 교차로~서울시설공단 교차로~무학교 구간○ 무정차정류소 : 용두신동아아파트(06162) ~ 동아제약(06185) 정류소(총 4개소) ※ 자세한 내용은 첨부파일을 참고 부탁드립니다."""
    ...
    data14 = """6/4(목)~6/17(수) 동부간선도로 지하차도 건설공사에 따른 교통통제 안내
동부간선도로 지하차도 건설공사관련 교통통제예정입니다.아래의 내용을 참고하시어 통행에 유의하시기 바랍니다.□통제개요○ 노선:동부간선도로○ 대상구간:동부간선도로 창동교 교차로(상계동 739) ~ 상계교 교차로 (상계동 699)○ 운영시간 :09:30~17:00(일부 1차선 이용제한)○ 운영기간 :26.6.4(목)~26.6.17(수)(기간 중 실 작업일 4일)- 세부일정 : 6.4(목) / 6.10(수) / 6.11(목) / 6.17(수)"""
    asyncio.run(ask_kanana(data11))